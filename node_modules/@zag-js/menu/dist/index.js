...
var dom = defineDomHelpers({
  ...
  getNextEl: (ctx) => nextById(dom.getElements(ctx), ctx.highlightedId, ctx.loop),
  getPrevEl: (ctx) => prevById(dom.getElements(ctx), ctx.highlightedId, ctx.loop),
  ...
  return (0, import_core2.createMachine)(
    ...
    },
    {
      ...
      guards: {
        ...
        hasFocusedItem: (ctx2) => ctx2.highlightedId !== null,
        isMenuFocused: (ctx2) => {
      ...
      actions: {
        ...
        invokeOnSelect(ctx2) {
          ...
          if (!ctx2.highlightedId)
            return;
          (_a = ctx2.onSelect) == null ? void 0 : _a.call(ctx2, ctx2.highlightedId);
